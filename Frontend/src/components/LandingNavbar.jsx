  ...
  return (
    <nav className="bg-transparent p-4">
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="font-semibold font-opensans text-[#313030] text-xl">Feedback Wizard</Link>
        ...
        <div>
          ...
          <button onClick={onAuthOpen} className="font-semibold font-opensans bg-white text-[#313030] py-2 px-4 rounded-full">Sign Up</button>
        </div>
      </div>
    </nav>
  );
